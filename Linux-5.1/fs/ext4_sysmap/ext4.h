...
#define ext4_dbg(s, args ...)		pr_info(s, ## args)
#define ext4_dbg1(s, args ...)
#define ext4_warn(s, args ...)		pr_warn(s, ## args)
#define ext4_info(s, args ...)		pr_info(s, ## args)
...
/* Don't use alignment for blocks */
#define EXT4_MB_NO_ALIGNMENT		0x4000
...
#define EXT4_PF_HUGEPAGES		0x40000000 /* Create with parents projid */
...
#define EXT4_PRINT_TIMING               0xBCD00010
#define EXT4_CLEAR_STATS                0xBCD00011
#define EXT4_PRINT_NUMA_STATS           0xBCD00012
#define EXT4_CLEAR_NUMA_STATS           0xBCD00013
